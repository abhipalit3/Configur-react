...
const SignUp = (props) => {
  return (
    <div className={`sign-up-container1 ${props.rootClassName} `}>
        ...
        <div className="sign-up-form-root thq-section-padding">
          <div className="sign-up-form1">
            <h2 className="sign-up-text10 thq-heading-2">
              {props.heading1 ?? (
                <Fragment>
                  <span className="sign-up-text23">Create an account</span>
                </Fragment>
              )}
            </h2>
            <p className="thq-body-large sign-up-text11">
              <span>
            ...
            <form className="sign-up-form2">
              ...
              <div className="sign-up-password">
                ...
                <span className="sign-up-text17 thq-body-small">
                  Forgot password
                </span>
              </div>
            </form>
            <button type="submit" className="sign-up-button1 thq-button-filled">
              <span className="sign-up-text18 thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="sign-up-text24">Create an account</span>
                  </Fragment>
                )}
              </span>
            </button>
            <p className="sign-up-text19 thq-body-large">
            ...
            <div className="sign-up-divider1">
            ...
            <div className="sign-up-container4">
              ...
              <button className="sign-up-button3 thq-button-outline">
                <svg
                  viewBox="0 0 860.0137142857142 1024"
                  className="sign-up-icon5"
                >
